...
reg [4:0] item_cntr=4'b00000;
wire not_zero, count_en;
// set a flag when we have items
assign not_zero = (item_cntr != 4'b00000) ? 1'b1 : 1'b0;
// setup is disabled, so just use init plus 2 clocks.
reg init1=0;
reg init2=0;
